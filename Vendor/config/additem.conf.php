<?php
  ...
  if($_POST){
       $name = $_POST["name"];
        ...
        $insert = "INSERT INTO `service`(`id`, `name`, `classification`, `city`, `county`, `subcounty`, `description`, `owner`) VALUES (NULL,'$name','$category','$city','$county','$subcounty','$description','owner address')";
